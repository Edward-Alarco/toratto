<?php
// Creamos la función para el post type departamento
function custom_post_departamento() {
    // Registramos la función 'departamento' según el codex de WP
    register_post_type( 'departamento',
    // (http://codex.wordpress.org/Function_Reference/register_post_type)
      // Agregamos todas funciones adicionales para el post type departamento
      array( 'labels' => array(
        'name' => __( 'Departamentos', 'andres-dev' ), /* El título del grupo */
        'singular_name' => __( 'Departamento', 'andres-dev' ), /* El título en singular */
        'all_items' => __( 'Todos los departamentos', 'andres-dev' ), /* Todos los items del menú */
        'add_new' => __( 'Agregar nuevo', 'andres-dev' ), /* Agregar uno nuevo */
        'add_new_item' => __( 'Agregar nuevo departamento', 'andres-dev' ), /* Agregar nuevo con título */
        'edit' => __( 'Editar', 'andres-dev' ), /* Editar */
        'edit_item' => __( 'Editar departamento', 'andres-dev' ), /* Editar item */
        'new_item' => __( 'Nuevo departamento', 'andres-dev' ), /* Nuevo titulo en visualización */
        'view_item' => __( 'Ver departamento', 'andres-dev' ), /* Ver item */
        'search_items' => __( 'Buscar departamento', 'andres-dev' ), /* Buscar item */
        ...
        'description' => __( 'Esto es un ejemplo de post type para departamentos', 'andres-dev' ), /* Custom Type Description */
        'public' => true,
        ...
        'rewrite' => array( 'slug' => 'departamento', 'with_front' => false ), /* Se especifica el slug de la url, por lo general es el mismo post type 'departamento' */
        'has_archive' => 'departamento', /* Puede cambiar el nombre del slug */
        'capability_type' => 'post',
        'hierarchical' => false,
        /* Habilitamos ciertos parámetros para el editor de cada departamento */
        'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
        ) /* Fin de las opciones */
      ); /* Fin del registro post type */
}
    // Agregando la función al init de WordPress
    add_action( 'init', 'custom_post_departamento');

// Creamos la taxonomía departamentosgenero para departamentos
add_action( 'init', 'crear_departamento_taxonomy' );
function crear_departamento_taxonomy() {
  register_taxonomy(
    'departamentosgenero', // Nombre de la taxonomía
    'departamento', // Nombre del post type que se le asignará
    array(
      'label' => __( 'Departamentos Categoría' ),
      'rewrite' => array( 'slug' => 'departamentosgenero' ),
      'hierarchical' => true,
    )
  );
}
...
// Creamos taxonomía tags para departamentos
add_action( 'init', 'crear_departamento_taxonomy_tags' );
function crear_departamento_taxonomy_tags() {
  register_taxonomy(
    'tag_departamento', // Nombre de la taxonomía
    'departamento', // Nombre del post type que se le asignará
    array(
      'rewrite' => array( 'slug' => 'tag_departamento' ),
      'hierarchical' => false,
...
register_taxonomy( 'departamentosgenero', 
array('departamento'), /* Agregue el post type al cual le asignara la taxonomía */
...
register_taxonomy( 'tags_departamento', 
array('departamento'), /* Agregue el post type al cual le asignara la taxonomía */
array('hierarchical' => false,    /* Si es true actua como categoria - si es false como etiqueta */
  'labels' => array(
    'name' => __( 'Tags departamentos', 'andres-dev' ), /* Nombre de la taxonomía */
...
// /* Registra soporte para categorías al post type departamento */
register_taxonomy_for_object_type( 'category', 'departamento' );
// /* Registrar soporte para tags al post type departamento */
register_taxonomy_for_object_type( 'post_tag', 'departamento' );
